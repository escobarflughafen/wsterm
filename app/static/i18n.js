...
const ZH = {
  ...
  'CUMULATIVE INDEX': '累计指数', 'Starts at 100 and compounds the observed excess return of each decision class. It describes this history; overlapping decisions do not become independent evidence.': '从 100 开始，复合累计每类决策的观察超额收益。它描述这段历史；重叠决策不会因此成为独立证据。',
  ...
  'Daily close-to-close CAD excess return; pre-trade state uses the previous completed close; exits use benchmark minus security. Equal-decision indices are descriptive, not evidence of independent bets.': '按日收盘到收盘计算加元超额收益；交易前状态采用上一个已完成收盘价；卖出采用基准减证券收益。等权决策指数仅作描述，不代表每笔交易是独立下注。',
  ...
  'INITIAL ENTRY': '首次建仓', 'ADD BELOW COST': '低于成本加仓', 'ADD ABOVE COST': '高于成本加仓',
