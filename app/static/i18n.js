...
const ZH = {
  ...
  'VIM MODE · h/l screens · j/k scroll · gg/G edges · i/: command': 'VIM 模式 · h/l 切换页面 · j/k 滚动 · gg/G 到顶/底 · i/: 输入命令', 'VIM MODE OFF': 'VIM 模式已关闭',
  'Enable Vim keys: h/l screens · j/k scroll · gg/G top/bottom · Ctrl-d/Ctrl-u half-page · b back · i/: command': '启用 Vim 按键：h/l 切换页面 · j/k 滚动 · gg/G 到顶/底 · Ctrl-d/Ctrl-u 半页 · b 返回 · i/: 输入命令',
