...
const ZH = {
  ...
  'GUEST · EPHEMERAL': '访客 · 临时', 'Uploaded portfolio data is erased when this guest container stops; only public market data persists.': '访客容器停止后，上传的投资组合数据将被清除；仅保留公开市场数据。',
